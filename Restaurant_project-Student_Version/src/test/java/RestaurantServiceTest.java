...
class RestaurantServiceTest {
    ...
    public void restaurant_adding_for_testing(){
        ...
        service.addRestaurant("Chekker's Pizza","allahabad",LocalTime.parse("09:30:00"),LocalTime.parse("22:00:00"));
    ...
    public void add_restaurant_should_increase_list_of_restaurants_size_by_1(){
        restaurant_adding_for_testing();
        int initialNumberOfRestaurants = service.getRestaurants().size();
        service.addRestaurant("Pumkin Tales","Chennai",LocalTime.parse("12:00:00"),LocalTime.parse("23:00:00"));
        assertEquals(initialNumberOfRestaurants + 1,service.getRestaurants().size());
    }
    //<<<<<<<<<<<<<<<<<<<<ADMIN: ADDING & REMOVING RESTAURANTS>>>>>>>>>>>>>>>>>>>>>>>>>>
}